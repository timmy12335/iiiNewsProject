...
<head>
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/MT/style.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/MT/owl.carousel.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/MT/owl.theme.default.min.css">
<link rel="stylesheet"
...
<script>
	var url = 'http://newsapi.org/v2/top-headlines?' + 'country=kr&'
...
// 									+ '<a href="' + artUrl + '"><div class="title"><div class="card-title">'
// 									+ title
// 									+ "</div ></div ></a>"
// 									+ '<div class="author" ><div class="card-text">新聞來源: '
// 									+ author
// 									+ "</div ></div >"
// 									+ '<div class="urlToImage" ><div class="bd-placeholder-img card-img-top" ><img style="height: 100%; width: 100%;" src='
<!-- // 									+ urlToImage -->
<!-- // 									+ " '/></div ></div >" -->
// 									+ "<div class='description'><div class='card-text'>"
// 									+ description
// 									+ "</div ></div></div></div></div>"
		...
		<div class="container-fluid">
			...
			<div>
				...
				<div  role="main" style="align: center; ">
					...
					<!-- 					<div class="card-columns"> -->
					<!-- 						<div class="card"> -->
					<div id="todayNews" style="column-break-inside: avoid" ><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
...
<!-- 	</div> -->
	...
	<div class="footer_box">
		...
		<div class="footer">
			<address>
				<p>快樂夥伴新媒體控股股份有限公司&nbsp;&nbsp;版權所有&nbsp;&nbsp;非經授權，不許轉載本網站內容<br>
				...
				cateSelect.onchange = function() {
					...
					function processData(data) {
						...
						for (var i = 0; i < data.articles.length; i++) {
							...
							content += '<div style="margen:10px; padding:10px;"><div class="bd-example" style="margin:10px auto; padding:10px; width:40%; height:40%;"><div class="card p-3" style="width:auto;height:auto;margen: 0 auto;align: center;"><div class="card-body" style="margen: 0 auto">'+ 
										'<a href="' + artUrl + '"><div class="title"><div class="card-title">'+ title + "</div ></div ></a>" + 
