...
function displayNewsOrderList(responseData){
	  var content = "<ul> <li class='table-header'>";
	      ...
	      content +=  " <div class='col col-4'>新聞編號</div><div class='col col-5'>&nbsp;&nbsp;&nbsp;&nbsp;金額</div> <div class='col col-6'>詳細資料</div></li>";	    
...
//			bgColor = (i % 2 == 0 ? "#d4f5b2" : "#b2f5e5");
			content += "<li class='table-row'>" + 
		               ...
		               "<div class='col-6 incss'><a class='astyle' href=<c:url value='/getOrderedSingleNews/"+newsOrderList[i].newsId+"' /> >新聞下載</a></div>"+
