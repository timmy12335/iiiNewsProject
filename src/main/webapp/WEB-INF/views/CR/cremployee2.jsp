...
<body>
	...
	<div class='card-body'>
		...
		<a href=<c:url value='/addemployee'/>><button
				class='btn btn-primary btn-icon-text' id='add'>新增客服人員</button></a>
		<div id='somedivS'></div>
	...
	<script>
		...
		function displayPageEmps(responseData) {
			...
			for (var i = 0; i < emp.length; i++) {
				...
				"<td class='text-center'>"
						...
						+ emp[i].empPk
						+ " disabled></td>"
						+ "<td class='text-center'><input type='text' size='6' name='empName' id=empName"
						+ (i)
						+ " value="
						+ emp[i].empName
						+ " ></td>"
						+ "<td class='text-center'><input type='text' size='20' name='empId' id=empId"
						+ (i)
						+ " value="
						+ emp[i].empId
						+ "></td>"
						+ "<td class='text-center'><input type='text' size='20' name='email' id=empemail"
						+ (i)
						+ " value="
						+ emp[i].empemail
						+ "></td>"
		...
		function searchByisStay() {
			...
			xhr0.open("GET", "<c:url value='/creemployee' />" + queryString,
					true);
			xhr0.send();
		...
		function searchByDate() {
			...
			var xhr0 = new XMLHttpRequest();
			xhr0.open("GET", "<c:url value='/getempByDate' />"
		...
		function searchByWord() {
			...
			var xhr0 = new XMLHttpRequest();
			xhr0.open("GET", "<c:url value='/getEmpByWord' />"
