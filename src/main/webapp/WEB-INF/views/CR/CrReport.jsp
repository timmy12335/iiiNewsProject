					...
					<c:otherwise>
						<c:forEach var='ser' items='${CrReport}'>
							<tr>
								...
								<td><input type="button" id="btn_update" value="修改"
									onclick="updateCrReport(${ser.pk})" /></td>
								<td><input type="button" id="btn_delete" value="刪除"
									onclick="deleteCrReport(${ser.pk})" /></td>
							</tr>
						</c:forEach>
					</c:otherwise>
				</c:choose>
